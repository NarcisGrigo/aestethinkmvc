...
<html lang="en">
    ...
    <body class="artistbody">
        <nav>
            <a href="http://127.0.0.1:5500/" class="btnho">HOME</a>
            <a href="http://127.0.0.1:5500/collections" class="btncl">COLLECTIONS</a>
            <a href="http://127.0.0.1:5500/contact" class="btnc">CONTACT</a>
        </nav>
        <h2 class="value">The value we offer</h2>
        <div class="artistpg">
            <img src="/img/stephane.jpg" alt="artist" class="artists"/>
            <img src="/img/aladino.jpg" alt="artist" class="artists"/>
            <img src="/img/alisya.jpg" alt="artist" class="artists"/>
            <img src="/img/howard.jpg" alt="artist" class="artists"/>
        </div>
        ...
        <div class="findmap">
            <img src="/img/Sydney-Map.jpg" alt="" class="maps"/>
            <div class="lorem">
