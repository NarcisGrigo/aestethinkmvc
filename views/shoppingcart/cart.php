...
if (isset($_POST['product_id'], $_POST['quantity']) && is_numeric($_POST['product_id']) && is_numeric($_POST['quantity'])) {
    ...
    $stmt = Database::dbConnexion()->prepare('SELECT * FROM products WHERE id = ?');
...
if ($products_in_cart) {
    ...
    $stmt = Database::dbConnexion()->prepare('SELECT * FROM products WHERE id IN (' . $array_to_question_marks . ')');
