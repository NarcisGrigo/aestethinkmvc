...
$stmt = Database::dbConnexion()->prepare('SELECT * FROM products ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = Database::dbConnexion()->query('SELECT * FROM products')->rowCount();
?>
