        ...
        <main>
            ...
            <div class="lgin">
                ...
                <form action="" method="post">
                    ...
                    <br/>
                    <br/>
                    <input type="password" placeholder="&nbsp P &nbsp A &nbsp S &nbsp S &nbsp W &nbsp O &nbsp R &nbsp D" class="pw" name="password"/>
            ...
            <div>
                <img src="/img/d3090dde93588424e7563d5b40a0a795.jpg" alt="" class="hands"/>
            </div>
        </main>
    </body>
</html>
